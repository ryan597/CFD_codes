...
function [df] = num_grad(func, X, h, Z, Sample_Size, aspect_ratio, ran)

df = zeros(size(Z,1),length(X));
...
for i=1:length(X)
    ...
    y1 = func(x1, Z, Sample_Size, aspect_ratio, ran);
    y2 = func(x2, Z, Sample_Size, aspect_ratio, ran);
